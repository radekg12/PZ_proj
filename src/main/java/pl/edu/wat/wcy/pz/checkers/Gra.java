...
public class Gra extends JComponent implements KoniecCzasuListener, ReplayListener {
    ...
    private Gracz gracz1, gracz2, aktualnyGracz, aktualnyPrzeciwnik;
    ...
    public Gra(OknoGlowne frame, Gracz gracz1, Gracz gracz2) {
        ...
        this.frame = frame;
        //TODO
        //pl.edu.wat.wcy.pz.checkers.Pionek.setSize(Math.min(width, height) / liczbaPol);
        //pl.edu.wat.wcy.pz.checkers.Pole.setSize(Math.min(width, height) / liczbaPol);
...
//        aktualnyPrzeciwnik = new pl.edu.wat.wcy.pz.checkers.Gracz(player1String, -1);
//        aktualnyGracz = new pl.edu.wat.wcy.pz.checkers.Gracz(player2String, 1);
        this.gracz1 = gracz1;
        this.gracz2 = gracz2;
    ...
    public void clean(ReplayEvent event) {
        aktywny = null;
        gracz1.getPionki().clear();
        gracz2.getPionki().clear();
        aktualnyGracz = gracz2;
        aktualnyPrzeciwnik = gracz1;
        pionkiTab = new Pionek[liczbaPol][liczbaPol];
        plansza = new Pole[liczbaPol][liczbaPol];
